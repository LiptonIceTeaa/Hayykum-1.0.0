...
<title>MOFA Query</title>
<link rel="stylesheet" href="../css/nicePage.css" media="screen">
<link rel="stylesheet" href="../css/MOFAPage.css" media="screen">
...
<meta property="og:title" content="MOFA Query">
...
<body class="u-body u-xl-mode">
	<header class="u-clearfix u-header u-palette-1-dark-1 u-header"
		...
		<nav
			...
			if (session.getAttribute("MOFAEmployeeEmail") == null) {

				response.sendRedirect("MOFALogin.jsp");
			}
			%>

			<script type="text/javascript">

var Msg ='<%=session.getAttribute("getAlertMOFAQueryUserDoesntExist")%>';
var Msg3 ='<%=session.getAttribute("mainStrMOFA")%>';
				...
				function alertName() {
					...
					if(Msg3 !="null"){
						...
						<%session.removeAttribute("mainStrMOFA");%>
					}
					...
					if (Msg != "null") {
						...
						Swal.fire({
						  ...
						  if (result.isConfirmed) {
							  window.location.href = "MOFAPage.jsp";
							  <%session.removeAttribute("getAlertMOFAQueryUserDoesntExist");%>
						  }
						});
			...
			<div class="u-custom-menu u-nav-container">
				<ul class="u-nav u-spacing-20 u-unstyled u-nav-1">
					<li class="u-nav-item"><a
						...
						href="../homePage.jsp" style="padding: 10px;">Logout</a></li>
				</ul>
			</div>
