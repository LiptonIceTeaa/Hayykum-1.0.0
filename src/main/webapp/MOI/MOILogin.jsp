...
<head>
    ...
    <link rel="stylesheet" href="../css/MOILogin.css" media="screen">
 ...
 <script type="text/javascript"> window.onload = alertName; </script>
    ...
    <section class="u-clearfix u-section-1" id="sec-b3ce">
      <div class="u-clearfix u-sheet u-sheet-1">
        <img class="u-image u-image-default u-preserve-proportions u-image-1" src="../images/MOIlogo1-13.png" alt="" data-image-width="224" data-image-height="225">
        <div class="u-align-center u-form u-grey-5 u-radius-15 u-form-1">
          <form action="../MOILogin" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;" redirect="true">
            <div class="u-form-email u-form-group">
              <label for="email-b96c" class="u-label">Email</label>
              <input type="email" placeholder="Enter a valid email address" id="email-b96c" name="emailMOI" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            <div class="u-form-group u-form-name">
              <label for="name-b96c" class="u-label">Password</label>
              <input type="password" placeholder="Enter Password" id="name-b96c" name="PasswordMOI" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
				...
				<div class="row mt-3">
					...
					<div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
						...
						<h6 class="text-uppercase fw-bold mb-4">
							<i class="fas fa-gem me-3"></i>Hayykum
						</h6>
					...
					<div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
						...
						<p>
							<a href="MOILogin.jsp" class="text-reset">MOI</a>
						</p>
					</div>
					<!-- Grid column -->
