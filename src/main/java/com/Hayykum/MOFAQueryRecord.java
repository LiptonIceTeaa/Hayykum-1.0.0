 ...
 */
@WebServlet("/MOFAQueryRecord")
public class MOFAQueryRecord extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (!ifExists) {
			...
			session.setAttribute("getAlertMOFAQueryUserDoesntExist", "Yes");// Just initialize a random variable.
...
//						mainStr.append("***** Personal information *****");
			...
			session.setAttribute("mainStrMOFA", mainStr);
			response.sendRedirect("MOFA/MOFAPage.jsp");
		}
	}
